...
public class AmenitiesFragment extends Fragment {
    public static final String TAG = makeLogTag(AmenitiesFragment.class);
    private View rootView;

    private List<Amenity> amenities = new ArrayList<Amenity>();

    private AmenitiesAdapter mAdapter;
     ...
     */
    public static AmenitiesFragment newInstance(List<Amenity> amenities) {
        AmenitiesFragment fragment = new AmenitiesFragment();
        fragment.amenities = amenities;
        return fragment;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        this.mAdapter = new AmenitiesAdapter(getActivity(), amenities);
