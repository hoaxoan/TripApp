...
import com.winter.dreamhub.util.AccessibilityUtils;
...
public class CustomRatingBar extends LinearLayout implements View.OnClickListener {
     ...
     */
    private static final int DEFAULT_UNFILLED_DRAWABLE_ID = R.drawable.ic_qu_star_outlined_34;

    /**
     * The drawable used if no filled drawable resource is specified.
     */
    private static final int DEFAULT_FILLED_DRAWABLE_ID = R.drawable.ic_qu_star_orange_34;
