...
public class Source {
    ...
    public static class WinterSource extends Source {

        public WinterSource(String key,
                            int sortOrder,
                            String name,
                            boolean active) {
            super(key, sortOrder, name, R.drawable.ic_designer_news, active);
    ...
    public static class WinterSearchSource extends WinterSource {

        public static final String WINTER_QUERY_PREFIX = "WINTER_QUERY_";
        private static final int SEARCH_SORT_ORDER = 400;

        public final String query;

        public WinterSearchSource(String query,
                                  boolean active) {
            super(WINTER_QUERY_PREFIX + query, SEARCH_SORT_ORDER, "“" + query + "”", active);
            this.query = query;
        }
