...
import com.winter.dreamhub.hotels.AmenitiesActivity;
...
import static com.winter.dreamhub.landmarks.LandmarkListFragment.BOOKMARK_RESULT_OK;
...
public class LandmarkDetailsActivity extends BaseActivity
        implements OnMapReadyCallback, LandmarkDetailsCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landmark_details_activity);
    ...
    private void loadEntityDetails(@Nullable Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(EXTRA_LANDMARK)) {
            ...
            final Call<Entity> entityCall = winterPrefs.getApi().getEntity(id);
    ...
    private void setDirectionCallWebsites() {
        ...
        String phoneNumber = "tel://".concat(entity.phone != null ? entity.phone : "");
    ...
    private void expandImageAndFinish() {
        ...
        if (draggableFrame.getTranslationY() > 0) {
            getWindow().setReturnTransition(
                    TransitionInflater.from(LandmarkDetailsActivity.this)
            ...
            new AnimUtils.TransitionListenerAdapter() {
                ...
                public void onTransitionStart(Transition transition) {
                    ...
                    commentsList.animate()
                            .alpha(0f)
                            .setDuration(50)
                            .setInterpolator(getLinearOutSlowInInterpolator(LandmarkDetailsActivity.this));
                }
            };
    ...
    private void setSummaryHistograms() {
        ...
        this.reviewRatingView.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                final Intent intent = new Intent(LandmarkDetailsActivity.this, SubmitReviewActivity.class);
        ...
        commentsCall.enqueue(new Callback<List<Review>>() {
            ...
            public void onResponse(Call<List<Review>> call, Response<List<Review>> response) {
                ...
                if (reviews != null && !reviews.isEmpty()) {
                    commentsAdapter = new ReviewsAdapter(LandmarkDetailsActivity.this, R.layout.landmark_details_review_item, reviews);
                    commentsList.setAdapter(commentsAdapter);
                    commentsList.setDivider(LandmarkDetailsActivity.this.getDrawable(R.drawable.list_divider));
    ...
    private void watchEntity() {
        if (winterPrefs.isLoggedIn() && winterPrefs.getUser() != null) {
            VisitedPlacesRequest request = new VisitedPlacesRequest(entity.trip_id, winterPrefs.getUser().id, entity.id, "landmarks", null);
    ...
    private LandmarkDetailsViewModel mViewModel;
    ...
    private void subscribeEntityChanges() {
        ...
        mViewModel.getEntityUpdatedEvent().observe(this, new Observer<Void>() {
            ...
            public void onChanged(@Nullable Void _) {
                LandmarkDetailsActivity.this.onBookmarkClicked(entity);
            }
        });
    }

    public static LandmarkDetailsViewModel obtainViewModel(FragmentActivity activity) {
        // Use a Factory to inject dependencies into the ViewModel
        ViewModelFactory factory = ViewModelFactory.getInstance(activity.getApplication());

        return ViewModelProviders.of(activity, factory).get(LandmarkDetailsViewModel.class);
    }
