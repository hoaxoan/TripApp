...
import static com.winter.dreamhub.restaurants.RestaurantsListFragment.BOOKMARK_RESULT_OK;
...
public class RestaurantDetailsActivity extends BaseActivity
        implements OnMapReadyCallback, RestaurantDetailsCallback {
    ...
    private void expandImageAndFinish() {
        ...
        if (draggableFrame.getTranslationY() > 0) {
            getWindow().setReturnTransition(
                    TransitionInflater.from(RestaurantDetailsActivity.this)
            ...
            new AnimUtils.TransitionListenerAdapter() {
                ...
                public void onTransitionStart(Transition transition) {
                    ...
                    commentsList.animate()
                            .alpha(0f)
                            .setDuration(50)
                            .setInterpolator(getLinearOutSlowInInterpolator(RestaurantDetailsActivity.this));
                }
            };
    ...
    private void setSummaryHistograms() {
        ...
        this.reviewRatingView.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                final Intent intent = new Intent(RestaurantDetailsActivity.this, SubmitReviewActivity.class);
        ...
        commentsCall.enqueue(new Callback<List<Review>>() {
            ...
            public void onResponse(Call<List<Review>> call, Response<List<Review>> response) {
                ...
                if (reviews != null && !reviews.isEmpty()) {
                    commentsAdapter = new ReviewsAdapter(RestaurantDetailsActivity.this, R.layout.landmark_details_review_item, reviews);
                    commentsList.setAdapter(commentsAdapter);
                    commentsList.setDivider(RestaurantDetailsActivity.this.getDrawable(R.drawable.list_divider));
    ...
    private void subscribeEntityChanges() {
        ...
        mViewModel.getEntityUpdatedEvent().observe(this, new Observer<Void>() {
            ...
            public void onChanged(@Nullable Void _) {
                RestaurantDetailsActivity.this.onBookmarkClicked(entity);
            }
        });
    }

    public static RestaurantDetailsViewModel obtainViewModel(FragmentActivity activity) {
        // Use a Factory to inject dependencies into the ViewModel
        ViewModelFactory factory = ViewModelFactory.getInstance(activity.getApplication());

        return ViewModelProviders.of(activity, factory).get(RestaurantDetailsViewModel.class);
    }
