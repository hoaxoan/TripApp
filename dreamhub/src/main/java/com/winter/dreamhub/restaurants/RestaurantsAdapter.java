...
import com.winter.dreamhub.databinding.RestaurantsItemBinding;
...
public class RestaurantsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final RestaurantsViewModel mViewModel;
    ...
    private EntitiesViewHolder createEntitiesHolder(ViewGroup parent) {
        RestaurantsItemBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext())
    ...
    /* package */ public static final class EntitiesViewHolder
        ...
        private final RestaurantsItemBinding binding;
        ...
        public EntitiesViewHolder(Context context, RestaurantsItemBinding binding) {
