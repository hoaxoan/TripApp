...
import com.winter.dreamhub.util.glide.CircleTransform;
...
public class AboutActivity extends BaseActivity {
    ...
    static class AboutPagerAdapter extends PagerAdapter {
        ...
        @Nullable
        @BindView(R.id.about_description) TextView plaidDescription;
        ...
        private View getPage(int position, ViewGroup parent) {
            switch (position) {
                case 0:
                    if (aboutPlaid == null) {
                        aboutPlaid = layoutInflater.inflate(R.layout.about_item, parent, false);
                        ...
                        SpannableString about1 = new SpannableString(
                                parent.getResources().getString(R.string.about_1));
            ...
            switch (viewType) {
                ...
                case VIEW_TYPE_LIBRARY:
                    return new LibraryHolder(LayoutInflater.from(parent.getContext()).inflate(
                            R.layout.about_library, parent, false));
            }
            throw new InvalidParameterException();
        }
